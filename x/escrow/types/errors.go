...
var (
	...
	ErrIncompatibleDenom             = errors.Register(ModuleName, 3000, "The denom provided does not match the denom stored in the contract")
	ErrDenomTraceNotExist            = errors.Register(ModuleName, 3001, "The denom hash provided does not exist")
)
