...
func NewMsgCreateEscrow(creator string, initiatorCoin sdk.Coin, fulfillerCoin sdk.Coin, startDate string, endDate string) *MsgCreateEscrow {
	return &MsgCreateEscrow{
		Creator:       creator,
		InitiatorCoin: initiatorCoin,
		FulfillerCoin: fulfillerCoin,
		StartDate:     startDate,
		EndDate:       endDate,
	}
}
