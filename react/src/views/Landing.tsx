    ...
    return (
        <div>
            <div>
                ...
                <blockquote>
                    "Discover our innovative escrow service designed for the Cosmos Hub ecosystem.
                    Using the powerful Cosmos SDK, we bring enhanced security and efficiency to transactions within the ecosystem."
                </blockquote>
            </div>
            <div>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li><b>Efficiency</b>: Our escrow service eliminates the middleman, making transactions faster and cheaper.</li>
                </ul>
            </div>
            <div>
                ...
                <div>
                    ...
                    <div>
                        ...
                        Input necessary parameters and transfer assets into the contract. Initiations are possible as both buyer or seller.
                    </div>
                </div>
                <div>
                    <div className="text-2xl font-bold">Step 2: Check Conditions</div>
                    <div>
                        Our smart contract evaluates predefined conditions to ensure agreed-upon terms are met before asset transfer.
                    </div>
                </div>
                <div>
                    <div className="text-2xl font-bold">Step 3: Release Assets</div>
                    <div>
                        Upon satisfying all conditions, assets are automatically released to the respective parties, ensuring a seamless, secure process.
                    </div>
                </div>
            </div>
        </div>
