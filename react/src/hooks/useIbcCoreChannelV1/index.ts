...
export default function useIbcCoreChannelV1() {
    ...
    return useQuery(
      ...
      () => {
        ...
        return client.IbcCoreChannelV1.query
          .queryChannel(channel_id, port_id)
          .then((res) => res.data);
      },
      options,
    );
  ...
  const QueryConnectionChannels = (
    ...
    return useInfiniteQuery(
      ...
      ({ pageParam = 1 }: { pageParam?: number }) => {
        ...
        query["pagination.count_total"] = true;
        return client.IbcCoreChannelV1.query
          .queryConnectionChannels(connection, query ?? undefined)
          .then((res) => ({ ...res.data, pageParam }));
      },
      {
        ...options,
  ...
  const QueryChannelClientState = (
    ...
    return useQuery(
      ...
      () => {
        const { channel_id, port_id } = key;
        return client.IbcCoreChannelV1.query
          .queryChannelClientState(channel_id, port_id)
          .then((res) => res.data);
      },
      options,
    );
  ...
  const QueryChannelConsensusState = (
    channel_id: string,
    port_id: string,
  ...
  const QueryPacketCommitment = (
    ...
    return useQuery(
      ...
      () => {
        ...
        return client.IbcCoreChannelV1.query
          .queryPacketCommitment(channel_id, port_id, sequence)
          .then((res) => res.data);
      },
      options,
    );
  ...
  const QueryPacketCommitments = (
    ...
    return useInfiniteQuery(
      ...
      ({ pageParam = 1 }: { pageParam?: number }) => {
        ...
        query["pagination.count_total"] = true;
        return client.IbcCoreChannelV1.query
          .queryPacketCommitments(channel_id, port_id, query ?? undefined)
          .then((res) => ({ ...res.data, pageParam }));
      },
      {
        ...options,
  ...
  const QueryPacketReceipt = (
    ...
    return useQuery(
      ...
      () => {
        const { channel_id, port_id, sequence } = key;
        return client.IbcCoreChannelV1.query
          .queryPacketReceipt(channel_id, port_id, sequence)
          .then((res) => res.data);
      },
      options,
    );
  ...
  const QueryPacketAcknowledgement = (
    channel_id: string,
    port_id: string,
    sequence: string,
    options: any,
    ...
    return useQuery(
      ...
      () => {
        const { channel_id, port_id, sequence } = key;
        return client.IbcCoreChannelV1.query
          .queryPacketAcknowledgement(channel_id, port_id, sequence)
          .then((res) => res.data);
      },
      options,
    );
  ...
  const QueryPacketAcknowledgements = (
    channel_id: string,
    port_id: string,
    query: any,
    options: any,
    ...
    return useInfiniteQuery(
      ...
      ({ pageParam = 1 }: { pageParam?: number }) => {
        ...
        query["pagination.count_total"] = true;
        return client.IbcCoreChannelV1.query
          .queryPacketAcknowledgements(channel_id, port_id, query ?? undefined)
          .then((res) => ({ ...res.data, pageParam }));
      },
      {
        ...options,
  ...
  const QueryNextSequenceReceive = (
    ...
    return useQuery(
      ...
      () => {
        const { channel_id, port_id } = key;
        return client.IbcCoreChannelV1.query
          .queryNextSequenceReceive(channel_id, port_id)
          .then((res) => res.data);
      },
      options,
    );
