  ...
  const QueryGroupMembers = (
    ...
    return useInfiniteQuery(
      ...
      ({ pageParam = 1 }: { pageParam?: number }) => {
        ...
        return client.CosmosGroupV1.query
          .queryGroupMembers(group_id, query ?? undefined)
  ...
  const QueryGroupsByAdmin = (
    ...
    return useInfiniteQuery(
      ...
      ({ pageParam = 1 }: { pageParam?: number }) => {
        ...
        query["pagination.count_total"] = true;
        return client.CosmosGroupV1.query
          .queryGroupsByAdmin(admin, query ?? undefined)
          .then((res) => ({ ...res.data, pageParam }));
      },
      {
        ...options,
  ...
  const QueryGroupPoliciesByGroup = (
    ...
    return useInfiniteQuery(
      ...
      ({ pageParam = 1 }: { pageParam?: number }) => {
        ...
        query["pagination.count_total"] = true;
        return client.CosmosGroupV1.query
          .queryGroupPoliciesByGroup(group_id, query ?? undefined)
          .then((res) => ({ ...res.data, pageParam }));
      },
      {
        ...options,
  ...
  const QueryGroupPoliciesByAdmin = (
    ...
    return useInfiniteQuery(
      ...
      ({ pageParam = 1 }: { pageParam?: number }) => {
        ...
        query["pagination.count_total"] = true;
        return client.CosmosGroupV1.query
          .queryGroupPoliciesByAdmin(admin, query ?? undefined)
          .then((res) => ({ ...res.data, pageParam }));
      },
      {
        ...options,
  ...
  const QueryProposalsByGroupPolicy = (
    ...
    return useInfiniteQuery(
      ...
      ({ pageParam = 1 }: { pageParam?: number }) => {
        ...
        query["pagination.count_total"] = true;
        return client.CosmosGroupV1.query
          .queryProposalsByGroupPolicy(address, query ?? undefined)
          .then((res) => ({ ...res.data, pageParam }));
      },
      {
        ...options,
  ...
  const QueryVotesByProposal = (
    ...
    return useInfiniteQuery(
      ...
      ({ pageParam = 1 }: { pageParam?: number }) => {
        ...
        query["pagination.count_total"] = true;
        return client.CosmosGroupV1.query
          .queryVotesByProposal(proposal_id, query ?? undefined)
          .then((res) => ({ ...res.data, pageParam }));
      },
      {
        ...options,
  ...
  const QueryVotesByVoter = (
    ...
    return useInfiniteQuery(
      ...
      ({ pageParam = 1 }: { pageParam?: number }) => {
        ...
        query["pagination.count_total"] = true;
        return client.CosmosGroupV1.query
          .queryVotesByVoter(voter, query ?? undefined)
          .then((res) => ({ ...res.data, pageParam }));
      },
      {
        ...options,
  ...
  const QueryGroupsByMember = (
    ...
    return useInfiniteQuery(
      ...
      ({ pageParam = 1 }: { pageParam?: number }) => {
        ...
        query["pagination.count_total"] = true;
        return client.CosmosGroupV1.query
          .queryGroupsByMember(address, query ?? undefined)
          .then((res) => ({ ...res.data, pageParam }));
      },
      {
        ...options,
