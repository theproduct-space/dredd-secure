...
const CreateContract = (props: CreateContractProps) => {
    ...
    const [selectedOwnToken, setSelectedOwnToken] = useState<
        IToken | undefined
                            ...
                            return (
                                <div className="condition">
                                    ...
                                    <div className="condition-value">
                                        ...
                                        <input value={condition.value} type={condition.condition.input ?? "datetime-local"}
                                            onChange={(e) => handleChangeConditionValue(e, index)}></input>
