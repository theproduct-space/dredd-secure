            ...
            {!isKeplrAvailable &&
                <div className="bg-red-900 text-center">
                    <Typography variant={"body-med"}>
                        Whoops… looks like you don’t have a compatible wallet extension installed on your browser.
                        Please install the <a className="italic font-bold underline" target={"_blank"} href={"https://www.keplr.app/download"}>Keplr wallet extension</a> in order to access our app.
                    </Typography>
                </div>
            }
