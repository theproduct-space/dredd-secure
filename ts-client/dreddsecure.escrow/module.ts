...
export const txClient = (
  ...
  return {
    async sendMsgFulfillEscrow({
      value,
      fee,
      memo,
    }: sendMsgFulfillEscrowParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          "TxClient:sendMsgFulfillEscrow: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        ...
        throw new Error(
          "TxClient:sendMsgFulfillEscrow: Could not broadcast Tx: " + e.message
        );
      }
    },

    async sendMsgCancelEscrow({
      value,
      fee,
      memo,
    }: sendMsgCancelEscrowParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          "TxClient:sendMsgCancelEscrow: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        throw new Error(
          "TxClient:sendMsgCancelEscrow: Could not broadcast Tx: " + e.message
        );
      }
    },

    async sendMsgCreateEscrow({
      value,
      fee,
      memo,
    }: sendMsgCreateEscrowParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          "TxClient:sendMsgCreateEscrow: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        console.log("hey, error inm tsclient", e);
        throw new Error(
          "TxClient:sendMsgCreateEscrow: Could not broadcast Tx: " + e.message
        );
      }
    },
    ...
    msgFulfillEscrow({ value }: msgFulfillEscrowParams): EncodeObject {
      try {
        return {
          typeUrl: "/dreddsecure.escrow.MsgFulfillEscrow",
          value: MsgFulfillEscrow.fromPartial(value),
        };
      } catch (e: any) {
        throw new Error(
          "TxClient:MsgFulfillEscrow: Could not create message: " + e.message
        );
      }
    },
    ...
    msgCancelEscrow({ value }: msgCancelEscrowParams): EncodeObject {
      try {
        return {
          typeUrl: "/dreddsecure.escrow.MsgCancelEscrow",
          value: MsgCancelEscrow.fromPartial(value),
        };
      } catch (e: any) {
        throw new Error(
          "TxClient:MsgCancelEscrow: Could not create message: " + e.message
        );
      }
    },
    ...
    msgCreateEscrow({ value }: msgCreateEscrowParams): EncodeObject {
      try {
        return {
          typeUrl: "/dreddsecure.escrow.MsgCreateEscrow",
          value: MsgCreateEscrow.fromPartial(value),
        };
      } catch (e: any) {
        throw new Error(
          "TxClient:MsgCreateEscrow: Could not create message: " + e.message
        );
      }
    },
  };
