...
export interface EscrowQueryAllEscrowResponse {
  Escrow?: EscrowEscrow[];
...
/**
 * @title dreddsecure/escrow/escrow.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryEscrowAll
   * @request GET:/dredd-secure/escrow/escrow
   */
  queryEscrowAll = (
    query?: {
    ...
    this.request<EscrowQueryAllEscrowResponse, RpcStatus>({
      path: `/dredd-secure/escrow/escrow`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryEscrow
   * @summary Queries a list of Escrow items.
   * @request GET:/dredd-secure/escrow/escrow/{id}
   */
   ...
   * @request GET:/dredd-secure/escrow/params
   */
